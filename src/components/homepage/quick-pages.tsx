                    ...
                    <div className={cardStyles}>
                        <div className={infoSection}>
                            <div className="w-full text-left">
                                ...
                                <Link href="/resume">
                                    <Button type="button" className="!bg-green-700 hover:!bg-green-800 focus:ring-2 focus:outline-none focus:!ring-green-600" variant="contained">
                    ...
                    <div className={cardStyles}>
                        <div className={infoSection}>
                            <div className="w-full text-left">
                                ...
                                <Link href="/portfolio">
                                    <Button type="button" className="!bg-pink-700 hover:!bg-pink-800 focus:ring-2 focus:outline-none focus:!ring-pink-600" variant="contained">
                                        Read more&nbsp;<SendIcon className="text-base flex items-center" />
                                    </Button>
                                </Link>
                            </div>
                    ...
                    <div className={cardStyles}>
                        <div className={infoSection}>
                            <div className="w-full text-left">
                                ...
                                <Link href="/interests">
                                    <Button type="button" className="!bg-purple-700 hover:!bg-purple-800 focus:ring-2 focus:outline-none focus:!ring-purple-600" variant="contained">
                                        Read more&nbsp;<SendIcon className="text-base flex items-center" />
                                    </Button>
                                </Link>
                            </div>
